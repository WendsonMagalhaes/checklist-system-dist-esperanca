                    ...
                    <div className="hidden md:block overflow-x-auto">
                        <table className="w-full text-sm border-collapse">
                            <thead className="bg-green-50 dark:bg-green-900/20">
                                <tr>
                                    <th className="px-4 py-2 text-left text-zinc-700 dark:text-zinc-300">Pedido</th>
                                    <th className="px-4 py-2 text-left text-zinc-700 dark:text-zinc-300">Cliente</th>
                                    <th className="px-4 py-2 text-left text-zinc-700 dark:text-zinc-300">Motorista</th>
                                    <th className="px-4 py-2 text-left text-zinc-700 dark:text-zinc-300">Status</th>
                                    <th className="px-4 py-2 text-left text-zinc-700 dark:text-zinc-300">Data</th>
                            ...
                            <tbody>
                                {checklists.map((c) => (
                                    <tr key={c.id} className="border-b border-green-200 dark:border-green-700 hover:bg-green-50 dark:hover:bg-zinc-700/50 transition">
                                        ...
                                        <td className="px-4 py-2 truncate">{c.pedido?.cliente ?? "-"}</td>
                                        <td className="px-4 py-2">{c.motorista?.name ?? "-"}</td>
